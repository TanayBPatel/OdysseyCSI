...
function Gemini() {
  ...
  const [input, setInput] = useState('Trending Food Items in India');
    ...
    if (input.trim()) {
      ...
      try {
        ...
        const response = await axios.post(
          'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyBHSqIYcjAu1IfQfbT7W2-shVsu2vkwx1M',
          {
            "contents": [
              {
                "parts": [
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-800">
      ...
      <div className="bg-gray-100 w-full max-w-lg shadow-xl rounded-lg overflow-hidden">
